...
<div class="page">
	<main>
		<div class="intro-section">
			<h1 class="name-hover">
				<span>v</span><span>i</span><span>v</span><span>a</span><span>n</span> <span>j</span><span
					>a</span
				><span>i</span><span>s</span><span>w</span><span>a</span><span>l</span>
			</h1>
			<p>i'm {currentAge}, based in sharon, ma. i build web apps and compete in robotics.</p>
			<p>
				currently working with sveltekit, javascript, java, and python. part of first tech challenge
				team #27369 deeptech.
			</p>
			...
			<div class="contact">
				...
				<div class="links">
					...
					<span class="link-with-tooltip">
						<a href="https://linkedin.com/in/vivanj" target="_blank" rel="noopener noreferrer"
							>linkedin</a
						>
						<span class="link-tooltip">vivanj</span>
					</span>
					<span class="link-with-tooltip">
						<a href="https://instagram.com/vivan.jaiswal1" target="_blank" rel="noopener noreferrer"
							>instagram</a
						>
					...
					<span class="chess-link">
						<a
							href="https://www.chess.com/member/chesschampv1"
							target="_blank"
							rel="noopener noreferrer">chess.com</a
						>
						{#if chessStats}
		...
		<div class="robotics">
			...
			{#if roboticsOpen}
				<div class="robotics-content">
					<p>
						i compete with team #27369 deeptech in <a
							href="https://www.firstinspires.org/robotics/ftc"
							target="_blank"
							rel="noopener noreferrer">first tech challenge</a
						>. we design, build, and program robots for competitions.
					</p>
					<p>
						it's taught me hardware and software integration and how to work under pressure with a
						team.
					</p>
				</div>
			{/if}
